...
<head>
    ...
    <!-- Dört İşlem -->
    <link rel="stylesheet" href="../assets/css/dort-islem.css">
                ...
                <div class="game-container">
                    <div class="game-box">
                        <div class="question-box">
                            ...
                            <div class="answers">
                                <button id="answer1" class="answer-button" onclick="checkAnswer('answer1')">Cevap
                                    1
                                </button>
                                <button id="answer2" class="answer-button" onclick="checkAnswer('answer2')">Cevap
                                    2
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="score-box">
                        ...
                        <div id="wrong">Yanlış: 0</div>
                        <button class="restart-button" onclick="resetGame()">Yeniden Başla</button>
                    </div>
                </div>
            </div>
        </div>
...
<script src="../assets/js/dort-islem.js"></script>
