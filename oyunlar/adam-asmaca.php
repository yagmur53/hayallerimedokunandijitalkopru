...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/adam-asmaca.css">
    ...
    <div class="hero_entry">
        <div class="container hero_container">
            <div class="hero_firstcard">
                <div class="game_wrapper game_wrapper-info">
                    <h1>Adam Asmaca</h1>
                    <p>Kelimeyi tahmin etmek için aşağıdaki alfabeyi kullanın veya ipucu almak için ipucuna tıklayın.</p>
                </div>
                <div class="game_wrapper">
                    <div id="game_buttons">
                    </div>
                    <p id="game_catagoryName"></p>
                    <div id="game_hold">
                    </div>
                    <p id="game_mylives"></p>
                    <p id="game_clue">İpucu -</p>
                    <div class="stickman_div">
                        <canvas id="game_stickman"></canvas>
                    </div>
                    <div class="game_container game_button-cs">
                        <button id="game_hint">İpucu Al</button>
                        <button id="game_reset">Tekrar Oyna</button>
                    </div>
                </div>
...
<script src="../assets/js/adam-asmaca.js"></script>
