...
<head>
    ...
    <!-- Bulut Patlatma -->
    <link rel="stylesheet" href="../assets/css/bulut-patlatma.css">
            ...
            <div class="hero_firstcard">
                <div id="game-wrapper">
                    ...
                    <div id="score-box">
                        ...
                        <p>Kalan Süre: <span id="timer">30</span> saniye</p>
                        <button class="restart-button" onclick="startGameTimer();createCloud();">Oyuna Başla</button>
                    </div>
...
<!-- Bulut Patlatma -->
<script src="../assets/js/bulut-patlatma.js"></script>
