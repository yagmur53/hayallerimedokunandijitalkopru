...
$sql    = "SELECT id, user_id, adsoyad, sehir, ilce, adres, yetimhane, hayal FROM hayaller";
...
<div class="hayaller_wrapper">
    ...
    <div class="header-section">
        <div class="container">
            <h1 class="display-4 mb-3">Çocukların Hayalleri</h1>
            <p class="lead">Her çocuğun bir hayali var, belki siz gerçekleştirebilirsiniz.</p>
        </div>
    </div>
...
<script src="./assets/js/hayaller.js"></script>
...
<script>
    ...
    function createDreamCard(dream) {
        return `
                <div class="dream-card" onclick="toggleDream(${dream.id})">
                    <div class="card-body p-4">
                        <div class="info-container mb-3">
                            <span class="info-item name">${dream.adsoyad}</span>
                            <span class="info-item">${dream.sehir}</span>
                            <span class="info-item">${dream.ilce}</span>
                            <span class="info-item">${dream.adres}</span>
                            <span class="info-item">${dream.yetimhane}</span>
                        </div>
                        <div class="dream-detail" id="dream-${dream.id}">
                            <h6 class="text-white-50 mb-3">Hayali:</h6>
